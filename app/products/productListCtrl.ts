module app.productListCtrl {
	...
	class ProductListCtrl implements IProductListCtrl {
		...
		constructor() {
			...
			var newProd = new app.models.Product(6, 'Axe', 'ABC-0045',
				new Date(2015, 10, 11), 25.00, 'Killer axe from space.',
